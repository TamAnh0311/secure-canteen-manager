...
export class IssuedOmrForm {
  ...
  @Column({ name: 'form_mode', type: 'enum', enum: OmrFormMode, enumName: 'omr_form_mode_enum' })
  ...
  @Column({ type: 'enum', enum: IssuedOmrFormStatus, default: IssuedOmrFormStatus.ISSUED })
  status!: IssuedOmrFormStatus;

  @Column({ name: 'consumed_sheet_id', type: 'uuid', nullable: true })
  consumedSheetId!: string | null;

  @Column({ name: 'reserved_sheet_id', type: 'uuid', nullable: true })
