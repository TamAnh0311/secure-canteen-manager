// English strings for the anonymous relative canteen (no auth, read-only).
// Must stay key-for-key in sync with vi/canteen.ts — locale-parity.test.ts enforces this.
const canteen = {
